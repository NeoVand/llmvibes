...
<svelte:head>
	<title>{data.part.title} — LLMVibes</title>
	<meta name="description" content={data.part.description} />
	<link rel="canonical" href={pageUrl} />
	<meta property="og:title" content="{data.part.title} — LLMVibes" />
	...
	<meta name="twitter:title" content="{data.part.title} — LLMVibes" />
...
<header class="part-header fixed top-0 right-0 left-0 z-50 flex items-center">
	...
	<div class="ml-auto flex flex-shrink-0 items-center gap-1 pr-3">
		...
		<a
			href="https://github.com/NeoVand/llmvibes"
			target="_blank"
...
<main class="part-page" style="padding-top: var(--header-height);">
	...
	<nav class="mx-auto max-w-4xl px-6 pt-2 pb-14" aria-label="Between parts">
		...
		<p class="mt-8 text-center text-[13px]" style="color: var(--color-text-secondary);">
			This is one part of a free, interactive 14-part course on how modern LLMs are built —
			<a
				href={resolve('/')}
				class="font-medium underline underline-offset-2"
				style="color: var(--color-primary);">read it all, with the in-browser training runs</a
			>.
		</p>
	</nav>
</main>
